...
/**
 * @brief Get the timestamp (ms) of the last USB MSC write operation.
 * @return Timestamp in milliseconds (from esp_log_timestamp), or 0 if no write has occurred.
 */
uint32_t tinyusb_msc_last_write_ms(void);
